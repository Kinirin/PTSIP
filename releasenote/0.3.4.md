...
**Status:** VERIFIED PUBLICATION CANDIDATE; source implementation complete; Specification rebind active; post-rebind verification passed  
**Canonical repository:** `Kinirin/PTSIP` (owner renamed from `kwaksinwoo01`)  
...
**Active bound Specification:** `0.3.4-draft` revision `afba3531e23d96c21b7216e49614b839158ca7d5`  
**Final post-rebind verification:** GitHub Actions run `31558658990` — PASS  
...
The existing `spec-v0.3.4-draft` tag/GitHub Release remains the earlier public design checkpoint and is not moved. The active normative identity for Tool `0.3.4` is `0.3.4-draft @ afba3531e23d96c21b7216e49614b839158ca7d5`.

Historical GitHub references created before the account rename may still use `kwaksinwoo01/PTSIP`; the canonical repository path is now `Kinirin/PTSIP`.
...
GitHub Actions run `31558658990` is the final post-rebind release-readiness evidence for Tool `0.3.4`. The run completed successfully and verified:

- complete pytest suite: **`138 passed`**;
- Tool source/package identity remains `0.3.4`: PASS;
- `ptsip spec` reports the active `0.3.4-draft @ afba3531e23d96c21b7216e49614b839158ca7d5` binding: PASS;
...
Tool `0.3.4` is therefore a verified publication candidate under the active Specification binding.
...
Post-rebind verification: PASSED
Publication candidate: VERIFIED
Final verification run: 31558658990
