# WU-09 — Split / Relationship / Associated-Artifact Target Proposals

> **Status:** PRE-CREATED / LOCKED  
> **Roadmap predecessor:** WU-08 — lifecycle migration analyzer  
> **Planning baseline:** `27bd53fcb7e2f132ec18950d75282d72f54415b3`  
> **Entry baseline:** not assigned; capture fresh branch HEAD on actual entry  
> **Successor:** WU-10 — preview + project-owner confirmation + safe apply

## 0. Purpose

Transform WU-08 migration findings into explicit, reviewable target-architecture proposals for Tool `0.3.6` without applying those proposals to the project.

WU-09 is the proposal-construction stage. It may describe a candidate target Responsibility Map delta, but project-owned architecture authority remains with the project owner and WU-10 confirmation/apply flow.
...
### WU-09E — rationale and alternatives
...
WU-09 does not collect owner confirmation, mutate profiles, perform CAS writes, or declare a proposed classification authoritative.

## 5. Completion gate

WU-09 is complete when migration findings can be converted into deterministic non-mutating target proposals; splits, relationships, and associated-artifact cases are represented explicitly; every proposal is traceable to evidence and source state; ambiguous cases remain explicit; and the proposal contract is ready for WU-10 preview/confirmation.

## 6. Entry discipline

Pre-created roadmap document only. Actual WU-09 entry requires WU-08 completion and a fresh exact branch HEAD recorded here.
