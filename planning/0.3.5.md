...
| `WU-13` | `S6` | Update `adoption/ADOPTION-GUIDE.md` from implemented VPMS behavior | `WU-12` | every documented VPMS behavior has an implemented/tested counterpart and the reference layout remains optional | `READY` | — |
...
```text
WU-13  adoption guide alignment
...
`WU-06`, `WU-07`, `WU-08`, `WU-09`, `WU-10`, `WU-11`, and `WU-12` are complete. WU-12 completion satisfies the remaining dependencies for `WU-13`, `WU-14`, and `WU-16`, so all three are now `READY`. `WU-15` remains eligible from `WU-01`; `WU-19` remains an independent root. `WU-17` still has unmet dependencies in `WU-13`, `WU-14`, `WU-15`, and `WU-16`, so it remains `PLANNED`. Their relative order is not an architectural dependency.
