...
| `WU-14` | `S6` | Update `agents/AGENT-CONTRACT.md` with VPMS purpose-first obligations | `WU-03`, `WU-10`, `WU-12` | agent rules bind to real VPMS metadata/diagnostics; no path-only purpose inference or silent Policy repair is permitted | `READY` | — |
...
```text
WU-14  agent contract alignment
WU-15  packaging inclusion
WU-16  minimum public / CLI surface
WU-19  install / upgrade + PyPI description alignment
```

`WU-06`, `WU-07`, `WU-08`, `WU-09`, `WU-10`, `WU-11`, `WU-12`, and `WU-13` are complete. WU-13 completion removes one dependency from `WU-17`; `WU-17` still has unmet dependencies in `WU-14`, `WU-15`, and `WU-16`, so it remains `PLANNED`. `WU-14`, `WU-15`, `WU-16`, and `WU-19` are immediately eligible, and their relative order is not an architectural dependency.
