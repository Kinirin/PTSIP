...
`WU-09` became eligible when `WU-04` completed. `WU-07` and `WU-08` remain eligible from `WU-03`; `WU-15` remains eligible from `WU-01`; `WU-06` and `WU-19` remain independent roots. `WU-05` is complete; its downstream `WU-11` and `WU-12` remain gated by their other dependencies. Their relative order is not an architectural dependency.
