...
`WU-07` and `WU-08` became eligible when `WU-03` completed. `WU-04` and `WU-05` remain eligible from `WU-02`; `WU-15` remains eligible from `WU-01`; `WU-06` and `WU-19` remain independent roots. Their relative order is not an architectural dependency.
