...
| --- | --- | --- | --- | --- | --- | --- |
| `WU-00` | `S0` | Governance record: add `ADR-0006-establish-vpms-verification-purpose-management.md` | — | ADR records VPMS name, responsibility boundary, reuse rule, sibling source ownership, and one-way PTSIP relationship without rewriting previous ADRs | `READY` | — |
