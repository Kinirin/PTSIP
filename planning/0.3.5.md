...
| `WU-12` | `S5` | Repository self-adoption: register representative real Verification Cases from the existing test inventory | `WU-03`, `WU-05`, `WU-06`, `WU-10` | real repository Product-purpose and Toolchain-purpose subsets are demonstrated; full regression path remains available | `READY` | — |
...
```text
WU-12  repository self-adoption
WU-15  packaging inclusion
WU-19  install / upgrade + PyPI description alignment
```

`WU-06`, `WU-07`, `WU-08`, `WU-09`, `WU-10`, and `WU-11` are complete. `WU-12` has `WU-03`, `WU-05`, `WU-06`, and `WU-10` satisfied and is `READY`. `WU-15` remains eligible from `WU-01`; `WU-19` remains an independent root. `WU-13`, `WU-14`, and `WU-16` remain gated by `WU-12` according to their declared dependencies. `WU-17` still has unmet dependencies in `WU-13`, `WU-14`, `WU-15`, and `WU-16`, so WU-11 completion does not make it `READY`. Their relative order is not an architectural dependency.
