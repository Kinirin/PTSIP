...
| `WU-05` | `S2` | Read-only PTSIP metadata bridge in `ptsip_bridge.py` | `WU-02` | stable target metadata is consumable through one narrow direction; no authority/profile write path exists | `COMPLETE` | bridge commit `7e1b9ecd6b985a8d1599ba5ef181f767c546969f`; `python -m pytest -q tests/test_vpms_ptsip_bridge_035.py` -> `13 passed`; committed blobs match tested blobs |
