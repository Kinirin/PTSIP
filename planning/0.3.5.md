...
| `WU-11` | `S4` | PTSIP/VPMS boundary integration tests | `WU-05`, `WU-10` | tests prove no `ptsip -> vpms` runtime dependency, no authority mutation, no classification mutation, and no conformance/result collapse | `READY` | — |
