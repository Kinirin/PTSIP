...
def test_legacy_topic_lookup_is_deterministic_but_not_canonical_subject_identity() -> None:
    runtime = ProjectAuthorityRuntime(ROOT)
    assert runtime.catalog.policy_id_for_legacy_topic("ptsip_establishment") == "SFP-0001"
