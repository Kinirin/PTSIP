...
- aligned the exception profile schema with every field required by the Tool 0.2.0 bound specification revision;
...
- Tool 0.2.0 remains bound to specification revision `895e12d27230af2bb99ad17a96e8df8ef41bc3e0` even when the `0.2.0-draft` family later evolves to a newer immutable normative snapshot.
