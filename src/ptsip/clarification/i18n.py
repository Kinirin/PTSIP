...
_TEXT = {
    "en": {
        ...
        "classification": "Which PTSIP architectural classification does this component belong to?",
        ...
        "executable": "Does this component contain executable implementation rather than only a declarative contract?",
    ...
    "ko": {
        ...
        "classification": "이 컴포넌트의 PTSIP 아키텍처 분류는 무엇입니까?",
        ...
        "executable": "이 컴포넌트는 선언형 계약만이 아니라 실행 가능한 구현을 포함합니까?",
...
_OPTIONS = {
    "classification": (
        ("PRODUCT", {"en": "Product-owned component", "ko": "Product 소유 컴포넌트"}),
        ("TOOLCHAIN", {"en": "Development Toolchain component", "ko": "개발 Toolchain 컴포넌트"}),
        ("NEUTRAL_CONTRACT", {"en": "Neutral non-executable contract", "ko": "중립 비실행 계약"}),
    ),
    "shipped": (
        ("YES", {"en": "Yes", "ko": "예"}),
        ("NO", {"en": "No", "ko": "아니요"}),
    ...
    "executable": (
        ...
        ("NO", {"en": "Declarative/non-executable only", "ko": "선언형/비실행 계약만 있음"}),
    ),
}
