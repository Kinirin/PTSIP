...
The exact PTSIP material used by a registrant or reporting party must be identified by a PTSIP version or immutable revision. Where both a version and immutable revision are reasonably available, both should be recorded.

Earlier PTSIP revisions may have been distributed under different license terms. This history does not revoke, rewrite, or invalidate rights that validly attached to an earlier copy under the license applicable to that copy.
